...
$qs=mysqli_query($link,"select max(`reg_no`) as id from patientregister")or die(mysqli_error($link));
...
<tr>
<td class="label1">Patient Type <font color="red">*</font> : </td>
<td><input type="radio" required="required" name="type" id="sex1" value="OP" onchange="showHint011(this.value)"  onclick="funconce1(this.value);"/>Out Patient 
<input type="radio" required="required" name="type" id="sex2"  onchange="showHint012(this.value)" onclick="funconce1(this.value);" value="IP"/> In Patient
