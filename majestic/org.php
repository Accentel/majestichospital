...
<html>
	...
	<div id="centre" class="table-responsive" style="height:auto;">
          ...
          <h1 style="color:red;" align="center">HOSPITAL DETAILS</h1><fieldset style="border:1px solid; height:auto; padding:10px;
          width:auto;">
			<form action="org_insert.php" method="post" autocomplete="off" >
			<div align="center"  style="width:100%">
					<table width="" align="center" class="table"  style=" float:center !important;" border="0" cellpadding="" cellspacing="">
						...
						<tr>
							...
							<td class="label1"><label for="cname">Hospital Name :</label></td>
							<td><input name="cname" id="cname" type="text" class=" form-control" value="<?php echo $a?>"/>
                            </td><input type="hidden" value="<?php echo $a6?>" name="id"> 
						</tr>
						
						<tr>
						
							<td class="label1"><label for="addr">Address :</label></td>
							<td> <textarea name="addr" class="textarea1" style="width:100%" class="form-control" ><?php echo $a1?></textarea></td>
						</tr>
