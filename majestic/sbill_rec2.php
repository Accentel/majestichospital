...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Lab Bill</u></b></h2></td></tr>
	...
	<?php
			...
			$sql= mysqli_query($link,"select  b.mrno,b.BillDate,b.phoneno,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount,b1.time,b1.cnt,b1.user from sbill b,bill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'")or die(mysqli_error($link));
			if($sql) 
			{
		...
		<table width="100%" border="0" align="center" style="font-size:13px;" cellpadding="0" cellspacing="0" >
         ...
         <tr>
          ...
          <tr>
           ...
           <td style="padding-left:10px;" width="15%"><div align="left"><b>Bill No.</b> </div></td>
			<td style="padding-left:10px;" width="35%"> : <?php echo $bno ?></td>
		  ...
		  <tr>
			<td colspan="4">
			<table align="center" width="100%" style="border-top:1px solid #000000;border-bottom:1px solid #000000;font-size:13px;" cellpadding="0" cellspacing="0">
				<tr >
					<td width="70%" style="padding-left:50px;font-size:13px;" align="left" ><b><u>Test Name</u></b></td>
					<td align="left" ><b><u>Amount</u></b></td>
					
				</tr>
				
			<?php	
				$sql1=mysqli_query($link,"SELECT serv_name,amount FROM sbill WHERE BillNO = '$bno'") or die(mysqli_error($link));
				if($sql1){
				...
				<td  align="left"><b><?php echo number_format($row1['Amount'],2) ?></b></td>
				</tr>
