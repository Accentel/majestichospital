...
<tr><td width="30%">MITRAL VALVE</td><td width="80%" align="left"> : <input type="text" name="MITRALVALVE" size="20"/></td></tr>
<tr><td>AORTIC VALVE</td><td align="left"> : <input type="text" name="AORTICVALUE" size="20"/></td></tr>
<tr><td>PULM VALVE</td><td align="left"> : <input type="text" name="PULMVALUE" size="20"/></td></tr>        
<tr><td>TRICUSPID VALVE</td><td align="left"> : <input type="text" name="TRICISPIDVALUE" size="20"/></td></tr>
<tr><td>I.A.S</td><td align="left"> : <input type="text" name="IAS" size="20"/></td></tr>        
<tr><td>I.V.S</td><td align="left"> : <input type="text" name="IVS" size="20"/></td></tr>
<tr height="10px"></tr>
</table><table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr><td>AORTIC ROOT</td><td align="left"> : <input type="text" name="AORTICROOT" size="20"/>cm</td><td>AORTIC OPENING</td><td align="left"> : <input type="text" name="AORTICOPENING" size="20"/>cm</td></tr>
<tr><td>LT.ATRIUM</td><td align="left"> : <input type="text" name="LTATRIUM" size="20"/>cm</td><td>RVOT</td><td align="left"> : <input type="text" name="RVOT" size="20"/>cm</td></tr>
<tr><td>IVS THICKNESS</td><td align="left"> : <input type="text" name="IVSTHICKNESS" size="20"/>cm</td><td>LVPW THICKNESS</td><td align="left"> : <input type="text" name="LVPWTHICKNESS" size="20"/>cm</td></tr>

<tr><td colspan="4"><b>LEFT VENTRICLE</b></td></tr>
<tr><td >LVIDo</td><td align="left" colspan="5"> : <input type="text" name="LVIDo" size="20"/>cm &nbsp;LVIDs <input type="text" name="LVDIs" size="20"/>cm&nbsp;RVIDd : <input type="text" name="RVDId" size="20"/>cm&nbsp;</td></tr>
<tr><td>EDV</td><td align="left"> : <input type="text" name="EDV" size="20"/>ml</td><td>ESV</td><td align="left"> : <input type="text" name="ESV" size="20"/>ml</td></tr>
<tr><td>EF</td><td align="left"> : <input type="text" name="EF" size="20"/>%</td><td>FS</td><td align="left"> : <input type="text" name="FS" size="20"/>%</td></tr>
<tr><td>LVM</td><td align="left"> : <input type="text" name="LVM" size="20"/>gm</td><td>EPSS</td><td align="left"> : <input type="text" name="EPSS" size="20"/>mm</td></tr>
</table><table width="100%" border="0" cellpadding="2" cellspacing="0">			
<tr height="10px"></tr>

<tr><td width="30%">RIGHT ATRIUM</td><td width="80%" align="left"> : <input type="text" name="RIGHTATRIUM" size="20"/></td></tr>
<tr><td>RIGHT VENTRICLE</td><td align="left"> : <input type="text" name="RIGHTVENTRICLE" size="20"/></td></tr>
<tr><td>PUL ARTERY</td><td align="left"> : <input type="text" name="PULARTERY" size="20"/></td></tr>        
<tr><td>PERICARDIUM</td><td align="left"> : <input type="text" name="PERICARDIUM" size="20"/></td></tr>
<tr><td colspan="2"><b>DOPPLER</b></td></tr>
<tr><td width="30%">MITRAL VELOCITY</td><td width="80%" align="left"> :E <input type="text" name="MITRALVELOCITYE" size="20"/>m/s&nbsp;A:<input type="text" name="MITRALVELOCITYA" size="20"/>m/s</td></tr>
<tr><td>AORTIC VELOCITY</td><td align="left"> : <input type="text" name="AORTICVELOCITY" size="20"/>m/s</td></tr>
<tr><td>PULMONARY VELOCITY</td><td align="left"> : <input type="text" name="PULMONARYVELOCITY" size="20"/>m/s</td></tr>        
<tr><td>TRICUSPID VELOCITY</td><td align="left"> : <input type="text" name="TRICUSPIDVELOCITY" size="20"/>m/s</td></tr>
<tr><td>TRJET VELOCITY</td><td align="left"> : <input type="text" name="TRJETVELOCITY" size="20"/>m/s</td></tr>
<tr><td>PASP</td><td align="left"> : <input type="text" name="PASP" size="20"/>m/s</td></tr>
<tr><td>CONCLUSION</td><td align="left"> : <textarea  name="CONCLUSION" rows="5" cols="30" ></textarea></td></tr>
<tr><td>CONSULTANT CARDIOLOGIST</td><td align="left"> : <input type="text" name="DOCTOR" size="30"/></td></tr>
</table>
...
<tr><td>PUSCELLS</td><td> : <input type="text" name="CUEPUSCELLS" size="20"/>  </td></tr> 
...
<tr><td width="30%">Ns1</td><td><input type="text" name="dsrns1" size="10"/></td></td><td> <input type="text" name="ns1value" value="<?php echo $ns1value; ?>"/> </td></tr> 
...
<tr><td width="30%">Urine for Pregnancy</td><td> : <input type="text" name="serumlipase"/> </td><td> <input type="text" name="serumlipase1" value="<?php echo $lipase ?>"/> </td></tr> 
