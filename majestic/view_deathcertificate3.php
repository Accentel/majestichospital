...
$().ready(function() {
	...
	<div id="conteneur">
		...
		include('logo.php');	
			...
			?>
		<div id="centre">
          <h1 style="color:red;" align="center">MEDICAL CERTIFICATE OF CAUSE OF DEATH LIST(4A)</h1>
...
<tr><td width="68" class="label1"><a href="add_deathertificate2.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0" border="1" id="expense_table" style="font-size:14px;">
<tr height="25px"><TH>S.NO.</TH><TH>UMR No</TH><TH>PATIENT NAME</TH><TH>DISEASE</TH><TH>JOIN DATE</TH><TH>DICHARGE DATE</TH>
...
<?php 
			 ...
			 // $n=$_REQUEST['name'];
			  $r=$_REQUEST['mrno'];
				...
				
				{
					...
					$k1= "SELECT * from `form4a` where  mrno='$r' order by id desc";
            ...
            <td><?php echo $mrno;?></td>
             ...
             <a href="edit_deathertificate2.php?id=<?php echo $aid?>"><img src="images/edit.gif" /></a></td>
             <td style="text-align:center;"><a href="deathcertificate_delete3.php?id=<?php echo $aid; ?>">
             <img src="images/delete.gif"></a></td><td style="text-align:center;"><a href="deathcertificate_print3.php?id=<?php echo $aid; ?>"><img src="images/print.png"></a></td></tr>
             <?php }
			 }
			 }
			 else{
				 $d=date('Y-m-d');
				$k= "SELECT * from `form4a`     order by id desc";
			...
			if($sq){	
             ...
             <a href="edit_deathertificate2.php?id=<?php echo $aid?>"><img src="images/edit.gif" /></a></td>
             <td style="text-align:center;"><a href="deathcertificate_delete3.php?id=<?php echo $aid; ?>">
             <img src="images/delete.gif"></a></td><td style="text-align:center;"><a href="deathcertificate_print3.php?id=<?php echo $aid; ?>"><img src="images/print.png"></a></td>
             </tr>
             <?php }$i++;
			 }
			 }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?><a href="view_deathcertificate3.php?next=0" ><?php } ?><img src="images/first.gif" title="First" alt="First" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
	   
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?>
			  <a  href="view_deathcertificate3.php?next=<?php echo ($pagecount - 1) ?>"><?php } ?><img src="images/previous.gif" title="Previous" alt="Previous" width="16" height="14" border="0"/></a></td>
		  <td width="10">&nbsp;</td>
	  
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?>
			  <a href="view_deathcertificate3.php?next=<?php echo ($pagecount + 1) ?>"><?php } ?><img src="images/next.gif" title="Next" alt="Next" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?><a href="view_deathcertificate3.php?next=<?php echo (($records - 1) / $nd) ?> ">  <?php } ?><img src="images/last.gif" title="Last" alt="Last" width="16" height="14" border="0"/></a></td>
	  </tr>
	</table>
	<table>
	<?php if ($rowscounts == 0) { ?>
