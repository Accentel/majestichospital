		  ...
		  <form name="myform" method="post" action="insert_bill.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
                    ...
                    <tr >
                        ...
                        <td align="left" >
                            <input type="text" name="bdate" id="bdate" style="width:188px;height:20px;"  readonly  value='<?php echo date('d-m-Y',strtotime($registerdate)) ; ?>'/>
                        </td>
                    </tr>
					<tr >
                        ...
                        <td align="left" >
                            ...
                            <input type="text" name="pname" id="pname" class="text" required readonly="readonly" value='<?php echo $patientname; ?>'/>
                        </td>
					...
					<tr >
                        ...
                        <td align="left" >
                            <input type="text" name="gender" required id="gender" style="width:188px;height:24px;" value='<?php echo $gender; ?>' readonly>
								
                        </td>
						 <td align="right" >Doctor Name :</td>
                        <td align="left" >
                            <input type="text" required name="dname" id="dname" style="width:188px;height:24px;" value='<?php echo $doctorname; ?>' readonly/>
					...
					<tr >
                     <td align="right" >Phone No :</td>
                        ...
                        <td align="left" >
                            <input type="text" name="ptype" id="ptype" style="width:188px;height:24px;" value='OP' readonly/>
