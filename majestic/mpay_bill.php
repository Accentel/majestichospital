...
window.onload=GetClock;
	...
	<div id="conteneur">
		...
		<?php
			...
			$dt3 = ltrim($dt2, '0');
			$str = "BL-".$dt3."-";
			$sql = mysqli_query($link,"select count(distinct BillNO) from mbill where BillNO like '$str%'")or die(mysqli_error($link));
			if($sql){
		...
		?>
          <div align="center" style="font-size:20px;color:red;font-weight:bold;margin-bottom:20px;">DHS Lab Bill</div>
		  <form name="myform" method="post" action="insert_mbill.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
                        <tr >
                        <td align="right" >UMR No. :</td>
                        <td align="left" >
                            <input type="text" name="mrno" id="mrno"  class="text" />
                        </td>
                    ...
                    <tr >
                        ...
                        <td align="left" >
                            <input type="text" name="bdate" id="bdate" style="width:188px;height:20px;" class="tcal" value="<?php echo date('Y-m-d') ?>"   /><input type="hidden" name="bdate1" id="bdate1" style="width:188px;height:20px;"   readonly />
                        </td>
                    </tr>
					<tr >
					...
					<tr >
                        ...
                        <td align="left" >
                            <input type="text" name="gender" required id="gender" style="width:188px;height:24px;" >
								
                        </td>
						 <td align="right" >Doctor Name :</td>
                        <td align="left" >
                            <input type="text" required name="dname" id="dname" style="width:188px;height:24px;" />
					...
					<tr >
                     <td align="right" >Phone No :</td>
                        ...
                        <td align="left" >
                            <input type="text" name="ptype" id="ptype" style="width:188px;height:24px;" />
		 ...
		 <div align="center"><input type="submit" name="submit" value="Save" Class="butt"/> <input type="button" value="Close" Class="butt" onclick="window.location.href='manual_lab_bill.php'"/></div>
