...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>General Cash Bill<!--Observation Patient Discharge Cash Bill--></u></b></h2></td></tr>
  </THEAD>
	<?php
  error_reporting(E_ALL);
  ini_set('display_errors', 1);
 ...
 ?> 
  ...
  <tr>
    <td colspan="5" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<table width="100%" border="0" align="center" style="font-size:13px;" cellpadding="0" cellspacing="0" >
          ...
          <td style="padding-left:10px;"><div align="left"><b>UMR No</b> </div></td>
            ...
            <td style="padding-left:10px;"><div><b>Bill Date</b> </div></td>
			<td style="padding-left:10px;"> : <?php echo $bdate ?></td>
      ...
      error_reporting(E_ALL);
      ini_set('display_errors', 1);
				$sql1=mysqli_query($link,"SELECT purpose,Amount FROM opbill1 WHERE BillNO = '$bno'")or die(mysqli_error($link));
				if($sql1){
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <input type="button" value="Close" id="cls" class="butt" onclick="self.location='view_opbill.php'"/></td>
      </tr>
