...
window.onload=GetClock;
	...
	<div id="conteneur">
		...
		ini_set('display_errors', 1);
			...
			$dt3 = ltrim($dt2, '0');
			$str = "BL-".$dt3."-";
			$sql = mysqli_query($link,"select count(distinct BillNO) from packagebill where BillNO like '$str%'")or die(mysqli_error($link));
			if($sql){
		...
		?>
          <div align="center" style="font-size:20px;color:red;font-weight:bold;margin-bottom:20px;">Package Extra Services Bill</div>
		  <form name="myform" method="post" action="insert_packagebill.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
					...
					<tr >
                        ...
                        <td align="left" >
                            <input type="text" required name="dname" id="dname" style="width:188px;height:24px;" readonly/>
