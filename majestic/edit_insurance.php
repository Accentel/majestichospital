...
?>
          ...
          <h1 style="color:red;" align="center">EDIT INSURANCE</h1>
...
<tr><td class="label1"><strong>Insurance Name </strong><font color="red">*</font> : </td><td><input type="text" name="locname" id="locname" class="text" value="<?php echo $locname; ?>"/></td></tr>
