...
$().ready(function() {
	...
	<div id="conteneur">
		...
		include('logo.php');	
			...
			?>
		<div id="centre">
          <h1 style="color:red;" align="center">EMERGENCY CERTIFICATES LIST</h1>
...
<tr><td width="68" class="label1"><a href="add_emergencycertificate.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0" border="1" id="expense_table" style="font-size:14px;">
<tr height="25px"><TH>S.NO.</TH><TH>UMR No</TH><TH>PATIENT NAME</TH><TH>AGE</TH><TH>APPOINTMENT DATE</TH>
...
<?php 
			 ...
			 // $n=$_REQUEST['name'];
			  $r=$_REQUEST['mrno'];
				...
				
				{
					...
					$k1= "SELECT * from emergencycertificate where  mrno='$r' order by eid desc";
             ...
             <a href="edit_emergencycertificate.php?id=<?php echo $aid?>"><img src="images/edit.gif" /></a></td>
             <td style="text-align:center;"><a href="emergency_delete.php?id=<?php echo $aid; ?>"><img src="images/delete.gif"></a></td><td style="text-align:center;"><a href="emergency_print.php?id=<?php echo $aid; ?>"><img src="images/print.png"></a></td></tr>
             <?php }
			 }
			 }
			 else{
				 $d=date('Y-m-d');
				$k= "SELECT * from emergencycertificate    order by eid desc";
			...
			if($sq){	
             ...
             <td style="text-align:center;">
             <a href="edit_emergencycertificate.php?id=<?php echo $aid?>"><img src="images/edit.gif" /></a></td>
             <td style="text-align:center;"><a href="emergency_delete.php?id=<?php echo $aid; ?>"><img src="images/delete.gif"></a></td><td style="text-align:center;"><a href="emergency_print.php?id=<?php echo $aid; ?>"><img src="images/print.png"></a></td>
             </tr>
             <?php }$i++;
			 }
			 }
