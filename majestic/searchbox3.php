...
$().ready(function() {
	...
	<div id="conteneur">
		...
		<div id="centre">
		 ...
		 <div align="center">
          <h1 style="color:red;" align="center">Search MR Number   </h1>
                       <form name="frm" method="post" action="medbill1.php" target="new" >
           
                
<table align="center" cellspacing="2">
<tr><td> UMR No : <input type="text" name="mrnum" id="name" required/></td>
...
$res=mysqlii_query($sql) or die(mysqlii_error());
$i=1;
