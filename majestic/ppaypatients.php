...
$().ready(function() {
	...
	<div id="conteneur">
		...
		include('logo.php');	
			...
			?>
		<div id="centre">
          <h1 style="color:red;" align="center">Package Payment IP List</h1>
...
<?php 
			  ...
			  $r=$_REQUEST['reg'];
				 ...
				 if($r != "")
				{
					$sq = mysqli_query($link,"SELECT * FROM `pfinalbill`  where umrno='$r'")or die(mysqli_error($link));
				
				}if($n != ""){
					$sq = mysqli_query($link,"SELECT * FROM `pfinalbill` where pname='$n'")or die(mysqli_error($link));
					}
            ...
            <td style="text-align:center;">
             <a href="add_opdigitalform.php?id=<?php echo $id?>"><img src="images/edit.gif" /></a></td>
             ...
             <?php //}
				 ...
				 $d=date('Y-m-d');
				 $fff="SELECT * FROM `pfinalbill`   order by id desc";
			...
			if($sq){	
             ...
             <a href="add_pfinalbill.php?id=<?php echo $mrno?>"><img src="images/edit.gif" /></a></td>
			 <td style="text-align:center;">
             <a href="pbill_rec2.php?bno=<?php echo $id?>"><img src="images/print.png" /></a></td>
