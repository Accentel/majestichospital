...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Lab Bill</u></b></h2></td></tr>
	...
	<?php
      ...
      ini_set('display_errors', 1);
			...
			$sql= mysqli_query($link,"select  b.mrno,b.BillDate,b.phoneno,b.PatientName,b.Age,b.Sex,b.DoctorName,b.conce_type,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount,b1.time,b1.cnt,b1.user from bill b,bill1 b1 where b.BillNO=b1.BillNO and b.BillNO='$bno'")or die(mysqli_error($link));
			if($sql)
			{
