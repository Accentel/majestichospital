...
document.getElementById("bal").value=amt1;
	...
	<div id="conteneur">
		...
		<?php
			// include("config.php");
			$bno = $_REQUEST['bno'];
			$sql = mysqli_query($link,"select  b.BillNO,b.BillDate,b.PatientName,b.Age,b.Sex,b.mrno,b.DoctorName,b.conce_type,b.remarks,b.phoneno,b.ptype,b1.Total,b1.Discount,b1.NetAmount,b1.PaidAmount,b1.BalanceAmount,b1.time,b1.status from bill b,bill1 b1 where b.BillNO=b1.BillNO and  b.BillNO = '$bno'")or die(mysqli_error($link));
			if($sql){
			...
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
					...
					<tr >
                        ...
                        <td align="left" >
							...
							<?php
								include("config.php");
								$sql1 = mysqli_query($link,"select dname1 from doct_infor")or die(mysqli_error($link));
								if($sql1){
								while($row1 = mysqli_fetch_array($sql1)){
							?>
							<option value="<?php echo $row1["dname1"] ?>"  <?php  if($dname==$row1['dname1']){ echo 'selected';} ?>><?php echo $row1["dname1"] ?></option>
							<?php }} ?>
							</select>
                        </td>
                    </tr>
					...
					<tr >
                        ...
                        <td align="left" >
                            <input type="text" name="conamt"  value="<?php echo $disc ?>" onkeyup="paidamt()" id="conamt"  class="text"/>
                        </td>
                    </tr>
					<tr >
                        ...
                        <td align="left" >
                            <input type="text" name="paid"  value="<?php echo $paid ?>"  onkeyup="paidamt()" id="paid" class="text"/>
                        </td>
                    </tr>
					<tr >
