...
$().ready(function() {
	...
	<div id="conteneur">
		...
		include('logo.php');	
			...
			?>
		<div id="centre">
          <h1 style="color:red;" align="center">MEDICAL CERTIFICATES LIST</h1>
...
<tr><td width="68" class="label1"><a href="add_medicalcertificate.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
...
<?php 
			 ...
			 // $n=$_REQUEST['name'];
			  $r=$_REQUEST['mrno'];
				...
				
				{
					...
					$k1= "SELECT * from medicalcertificate where  mrno='$r' order by mid desc";
            ...
            <td><?php echo $mrno;?></td>
             ...
             <a href="edit_medicalcertificate.php?id=<?php echo $aid?>"><img src="images/edit.gif" /></a></td>
             <td style="text-align:center;"><a href="medicalcertificate_delete.php?id=<?php echo $aid; ?>"><img src="images/delete.gif"></a></td><td style="text-align:center;"><a href="medicalcertificate_print.php?id=<?php echo $aid; ?>"><img src="images/print.png"></a></td></tr>
             <?php }
			 }
			 }
			 else{
				 $d=date('Y-m-d');
				$k= "SELECT * from medicalcertificate    order by mid desc";
			...
			if($sq){	
             ...
             <td style="text-align:center;">
             <a href="edit_medicalcertificate.php?id=<?php echo $aid?>"><img src="images/edit.gif" /></a></td>
             <td style="text-align:center;"><a href="medicalcertificate_delete.php?id=<?php echo $aid; ?>"><img src="images/delete.gif"></a></td><td style="text-align:center;"><a href="medicalcertificate_print.php?id=<?php echo $aid; ?>"><img src="images/print.png"></a></td>
             </tr>
             <?php }$i++;
			 }
			 }
