...
xmlhttp.open("GET","search16.php?q="+str+"&itype="+itype,true);
xmlhttp.send();
}
</script>
<script>
		  ...
		  <form name="myform" method="post" action="insert_bill.php">
			<table width="100%" border="0" cellpadding="4" cellspacing="0">
                    ...
                    <tr >
                        ...
                        <td align="left" >
                        <?php
$bno = isset($bno) ? $bno : ''; // Initialize $bno if not set
?>
...
<?php } } ?>
					...
					<tr >
                        ...
                        <td align="left" >
                            ...
                            <?php
$sno = isset($sno) ? $sno : ''; // Initialize $sno if not set
?>
<input type="text" name="sampleno" id="sampleno" class="text" value="<?php echo $sno; ?>" required readonly/>
					...
					<table width="100%" id="TABLE1">
					  <thead>
					   ...
					   <tr>
					   <td ><input type="text" class="text cname1" name="tname[]"  id="cname1" onfocus="showHint21(this.value);" onchange="showHint21(this.value);" required/></td>
						<td ><input type="text" class="text " name="cost[]" id="cost1"   class="txt"/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname2" name="tname[]" id="cname2" onfocus="showHint22(this.value);"  onchange="showHint22(this.value);" /></td>
						<td ><input type="text" class="text " name="cost[]" id="cost2"   class="txt"/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname3" name="tname[]" id="cname3" onfocus="showHint23(this.value);" onchange="showHint23(this.value);"/></td>
						<td ><input type="text" class="text " name="cost[]" id="cost3"   class="txt"/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname4" name="tname[]" id="cname4" onfocus="showHint24(this.value);" onchange="showHint24(this.value);"/></td>
						<td ><input type="text" class="text" name="cost[]" id="cost4" readonly  class="txt"/></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname5" name="tname[]" id="cname5" onfocus="showHint25(this.value);" onchange="showHint25(this.value);"/></td>
						<td ><input type="text" class="text" name="cost[]" id="cost5" readonly /></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname6" name="tname[]" id="cname6" onfocus="showHint26(this.value);" onchange="showHint26(this.value);"/></td>
						<td ><input type="text" class="text" name="cost[]" id="cost6" readonly /></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname7" name="tname[]" id="cname7" onfocus="showHint27(this.value);" onchange="showHint27(this.value);"/></td>
						<td ><input type="text" class="text" name="cost[]" id="cost7" readonly /></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname8" name="tname[]" id="cname8" onfocus="showHint28(this.value);" onchange="showHint28(this.value);" /></td>
						<td ><input type="text" class="text" name="cost[]" id="cost8" readonly /></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname9" name="tname[]" id="cname9" onfocus="showHint29(this.value);" onchange="showHint29(this.value);"/></td>
						<td ><input type="text" class="text" name="cost[]" id="cost9" readonly /></td>
						
						</tr>
						<tr>
					   <td ><input type="text" class="text cname10" name="tname[]" id="cname10" onfocus="showHint30(this.value);" onchange="showHint30(this.value);"/></td>
        ...
        </table> <div align="center"><input type="submit" name="submit" value="Save" Class="butt" onclick="window.location.href='new_lab_bill.php'"/>
         <input type="button" value="Close" Class="butt" /></div>
