...
<?php 
			  ...
			  $sq = mysqli_query($link,"select lr_no,b.suppl_name,suppl_inv_no,rec_by,total,grn from phr_purinv_mast1 as a,phr_supplier_mast as b where a.suppl_code=b.suppl_code and upper(b.SUPPL_NAME) like upper('$n%')")or die(mysqli_error($link));
			 ...
			 $sq = mysqli_query($link,"select lr_no,b.suppl_name,suppl_inv_no,rec_by,total,grn from phr_purinv_mast1 as a,phr_supplier_mast as b where a.suppl_code=b.suppl_code  order by a.lr_no desc  ")or die(mysqli_error($link));
			 ...
			 ?>
             <tr height="25px"><td style="text-align:center;"><?php echo $i;?></td><td><?php echo $grn;?></td><td><?php echo $sn;?></td><td><?php echo $invno;?></td><td><?php echo $recby;?></td><td><?php echo $total;?></td><td style="text-align:center;"><a href="view_purchase_invoice1.php?id=<?php echo $pid?>"><img src="images/view.gif" /></a></td><td><a href="PurchaseInvoice_Report1.php?lr_id=<?php echo $pid ?>" target="_blank"><img src="images/pdf_icon.gif" border="0"></a></td></tr>
             <?php }$i++;}
			 }
			 }
			 ?></table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?><a href="purchase_invoice_list1.php?next=0" ><?php } ?><img src="images/first.gif" title="First" alt="First" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
	   
		<td width="25" align="right"><?php if (!($pagecount == 0)) { ?>
			  <a  href="purchase_invoice_list1.php?next=<?php echo ($pagecount - 1) ?>&amp;searchname=<?php echo $n ?>"><?php } ?><img src="images/previous.gif" title="Previous" alt="Previous" width="16" height="14" border="0"/></a></td>
		  <td width="10">&nbsp;</td>
	  
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?>
			  <a href="purchase_invoice_list1.php?next=<?php echo ($pagecount + 1) ?>&amp;searchname=<?php echo $n ?>"><?php } ?><img src="images/next.gif" title="Next" alt="Next" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
		<td width="25" align="right"><?php if ($rowscounts > 0) { ?><a href="purchase_invoice_list1.php?next=<?php echo (($records - 1) / $nd) ?>&amp;searchname=<?php echo $n ?>" >  <?php } ?><img src="images/last.gif" title="Last" alt="Last" width="16" height="14" border="0"/></a></td>
	  </tr>
	</table>
	<table>
	<?php if ($rowscounts == 0) { ?>
