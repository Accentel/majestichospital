...
$().ready(function() {
	...
	<div id="conteneur">
		...
		include('logo.php');	
			...
			?>
		<div id="centre">
          <h1 style="color:red;" align="center">ESSENTIALITY CERTIFICATE LIST</h1>
...
<tr><td width="68" class="label1"><a href="add_essentiality.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
...
<?php 
			 ...
			 // $n=$_REQUEST['name'];
			  $r=$_REQUEST['mrno'];
				...
				
				{
					...
					$k1= "SELECT * from essentiality where  mrno='$r' order by id desc";
             ...
             <a href="edit_essentiality.php?id=<?php echo $aid?>"><img src="images/edit.gif" /></a></td>
             <td style="text-align:center;"><a href="essentiality_delete.php?id=<?php echo $aid; ?>"><img src="images/delete.gif"></a></td><td style="text-align:center;"><a href="essentiality_print.php?id=<?php echo $aid; ?>"><img src="images/print.png"></a></td></tr>
             <?php }
			 }
			 }
			 else{
				 $d=date('Y-m-d');
				$k= "SELECT * from essentiality    order by id desc";
