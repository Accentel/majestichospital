	...
	<div id="conteneur">
		...
		<div id="centre">
		 ...
		 <div align="center">
                       ...
                       <form name="frm" method="post" action="services_view.php">
...
<h1 style="color:red;" align="center">SERVICES VIEW LIST</h1>
<table border="0" cellpadding="2" cellspacing="2">
<tr><td width="68" class="label1"><a href="add_services.php" title="Add New Record"><img src="images/add1.gif"></a></td></tr>
</table>
			 ...
			 if(isset($_POST['submit'])){
			  ...
			  $mdepname=$res['amount'];
				...
				if ($rowstart <= $rowend && $remainig_records == $rowstart) {
					...
					$rowscounts = 0;
			 ?>
			 <tr height="25px"><td style="text-align:center;"><?php echo $i;?></td><td><?php echo $depname;?></td><td><?php echo $mdepname;?></td><td style="text-align:center;"><a href="edit_services.php?id=<?php echo $did?>"><img src="images/edit.gif" /></a></td></tr>
             <?php }$i++;}
			 } }?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<td width="25" align="right"><?php  if (!($pagecount == 0)) { ?><a href="services_view.php?next=0" ><?php } ?><img src="images/first.gif" title="First" alt="First" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
	   
		<td width="25" align="right"><?php  if (!($pagecount == 0)) { ?>
			  <a  href="services_view.php?next=<?php echo ($pagecount - 1) ?>"><?php } ?><img src="images/previous.gif" title="Previous" alt="Previous" width="16" height="14" border="0"/></a></td>
		  <td width="10">&nbsp;</td>
	  
		<td width="25" align="right"><?php  if ($rowscounts > 0) { ?>
			  <a href="services_view.php?next=<?php echo ($pagecount + 1) ?>"><?php } ?><img src="images/next.gif" title="Next" alt="Next" width="16" height="14" border="0"/></a></td>
		<td width="10">&nbsp;</td>
		<td width="25" align="right"><?php  if ($rowscounts > 0) { ?><a href="services_view.php?next=<?php echo (($records - 1) / $nd) ?>" >  <?php } ?><img src="images/last.gif" title="Last" alt="Last" width="16" height="14" border="0"/></a></td>
	  </tr>
	</table>
	<table>
	<?php if(isset($_REQUEST['$rowscounts == 0']))  if ($rowscounts == 0) { ?>
           <tr >
